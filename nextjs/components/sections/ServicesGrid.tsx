      ...
      <div className="container-x">
        ...
        <ul data-reveal-group className="mt-16 grid gap-5 md:grid-cols-2 lg:mt-20">
          {services.map((service) => (
            <li key={service.slug}>
              <Link href={serviceHref(service.slug)} className="group flex h-full flex-col rounded-card border border-line bg-light p-5 transition-shadow duration-500 hover:shadow-[0_30px_70px_-40px_rgba(23,23,23,0.45)] sm:p-7">
