...
// Runs after each navigation: jump to the top, or to the requested section when the URL has a hash.
function ScrollOnNavigate({ pathname }: { pathname: string }) {
  useLayoutEffect(() => {
...
export function ClientShell({ children }: { children: ReactNode }) {
  ...
  return (
    <MotionConfig reducedMotion="user">
      ...
      >
        {children}
        <ScrollOnNavigate pathname={pathname} />
      </motion.main>
